---
title: Unity Android Status Bar
date: 2017-02-15 17:52:07
tags: [Unity]
---
...
class StatusBar
{
    ...
    /**
     * Manipulates the system application chrome to change 
	 the way the status bar and navigation bar work
     *
     * References:
    ...
    private const uint DEFAULT_BACKGROUND_COLOR = 0xff000000;
		...
		// Added in API 14 (Android 4.0.x): Low profile for games, book readers, and video players; 
        //the status bar and/or navigation icons are dimmed out (if visible)
		...
		// 0x80000000; 
        // Added in API 21 (Android 5.0): tells the Window is responsible for drawing the background for the system bars. 
        //If set, the system bars are drawn with a transparent background and the corresponding areas in this window are filled with the colors 
        //specified in getStatusBarColor() and getNavigationBarColor()
